...
function waitForWindowEvent(eventName: string, timeoutMs: number): Promise<void> {
...
export async function scrollToSectionWhenReady(sectionId: string): Promise<void> {
