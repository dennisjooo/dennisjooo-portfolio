export const SSR_CRITICAL_CSS = [
  ...
  "#__ssr_loader .ssr-fill{height:100%;width:100%;background:linear-gradient(90deg,transparent,#0a0a0a 10%,#0a0a0a 90%,transparent);animation:ssr-flash 1.2s ease-in-out infinite}",
  "@media(prefers-color-scheme:dark){#__ssr_loader .ssr-fill{background:linear-gradient(90deg,transparent,#fafafa 10%,#fafafa 90%,transparent)}}",
  "html.dark #__ssr_loader .ssr-fill{background:linear-gradient(90deg,transparent,#fafafa 10%,#fafafa 90%,transparent)!important}",
  "html.light #__ssr_loader .ssr-fill{background:linear-gradient(90deg,transparent,#0a0a0a 10%,#0a0a0a 90%,transparent)!important}",
