...
const securityHeaders = [
    {
        ...
        value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.clerk.accounts.dev; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; font-src 'self' data:; connect-src 'self' https://cdn.jsdelivr.net https://raw.githubusercontent.com https://*.clerk.accounts.dev https://clerk.accounts.dev; frame-src 'self' https://*.clerk.accounts.dev; frame-ancestors 'none';"
    },
    {
